    ...
    <div className='bg-white rounded-md border-2 border-gray-200 py-4 px-4 mt-4'>
     <div className="flex justify-between lg:flex-row flex-col lg:gap-y-0 gap-y-2">
      <div className="flex flex-wrap gap-2 items-center">
        ...
        <button className="bg-transparent text-gray-600 px-2 py-2 text-sm rounded border border-gray-300">Filter by Project</button>
        <button className="bg-gray-200 text-gray-600 px-2 text-sm py-2 rounded">+ Add to projects</button>
      </div>
