...
//               />
// {profileImage ? (
//   <button className='text-gray-500 mt-1 hover:underline' onClick={handleRemoveImage}>Remove</button>
// ) : (
//   <button onClick={handleUploadClick} className='text-blue-500 mt-2 hover:underline'>Upload photo</button>
// )}
//               </div>
...
//       <div class="peer rounded-full outline-none duration-100 after:duration-500 w-12 h-6 bg-blue-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-500  after:content-['No'] after:absolute after:outline-none after:rounded-full after:h-5 after:w-5 after:bg-white after:top-0.5 after:left-0.5 after:flex after:justify-center after:items-center  after:text-xs after:font-bold peer-checked:after:translate-x-6 peer-checked:after:content-['Yes'] peer-checked:after:border-white"></div>
//     </label>
//   </div>
// );
