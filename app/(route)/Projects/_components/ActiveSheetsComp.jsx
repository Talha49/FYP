...
const ActiveSheetsComp = () => {
  ...
  return (
    <div className="py-10">
     ...
     <Link href={`/Projects/1/ActiveSheets/1`} className='bg-blue-200 rounded-full px-6 py-3 mr-6 text-sm text-blue-900 hover:bg-blue-400 hover:text-blue-100 font-semibold'>View all Sheets</Link>
     </div>
